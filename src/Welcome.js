        ...
        <div style={styles.container}>
            ...
            <div style={styles.iconWrap}>
                ...
                <div style={styles.item}>
                    <div>
                        <img src={"../images/earn.png"} style={styles.iconImg} />
                    </div>
                ...
                <div style={styles.item}>
                    <div>
                        <img src={"../images/buy.png"} style={styles.iconImg} />
                    </div>
                    <div style={styles.iconText}>
                ...
                <div style={styles.item}>
                    <div>
                        <img src={"../images/use.png"} style={styles.iconImg} />
                    </div>
                    <div style={styles.iconText}>
                ...
                <div style={styles.item}>
                    <div>
                        <img src={"../images/park.png"} style={styles.iconImg} />
                    </div>
                    <div style={styles.iconText}>
            ...
            <div style={styles.qrcode}>
                <img src={"../images/qrcode.png"} style={styles.qrImg} />
            </div>
            {/* /qr-code */}
